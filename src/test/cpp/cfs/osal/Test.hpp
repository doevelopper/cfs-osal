...
namespace cfs::osal::test
{
    ...
    class GtestExtendedEventListener : public TestEventListener
{
...
public:
    ...
    explicit GtestExtendedEventListener(TestEventListener* theEventListener) : eventListener(theEventListener)
    {
        showTestCases = true;
        showTestNames = true;
        showSuccesses = true;
